...
import testValue
from popbill import PopbillException, Statement, StatementDetail, StatementService
...
try:
    ...
    statement = Statement(
        ...
        # 전자명세서 문서 유형, 121-명세서, 122-청구서, 123-견적서, 124-발주서, 125-입금표, 126-영수증
        itemCode=121,
