...
try:
    ...
    cashbill = Cashbill(mgtKey = "20150326-04", # 문서관리번호, 1~24자리, 영문,숫자,-,_ 조합으로 공급자별 고유번호 생성
                        tradeType = "승인거래", # 현금영수증 형태, '승인거래'/'취소거래'
                        tradeUsage = "소득공제용", # 거래유형, '소득공제용'/'지출증빙용'
                        taxationType = "과세", # 과세형태, '과세'/'비과세'
                        
                        identityNum = "01043255117", # 거래처 식별번호
    ...
    result = cashbillService.register(testValue.testCorpNum,cashbill)
