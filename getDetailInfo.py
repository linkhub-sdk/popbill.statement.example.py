...
try:
    ...
    print("itemCode(전자명세서 문서 유형) : %s" % statement.itemCode)
    print("mgtKey(문서번호) : %s" % statement.mgtKey)
    print("invoiceNum(팝빌 승인번호) : %s" % statement.invoiceNum)
    print("formCode(맞춤양식 코드) : %s" % statement.formCode)
    print("writeDate(작성일자) : %s" % statement.writeDate)
    print("taxType(과세형태) : %s" % statement.taxType)
    ...
    print("senderTaxRegID(발신자 종사업장 식별번호) : %s" % statement.senderTaxRegID)
    ...
    print("senderEmail(발신자 메일주소) : %s" % statement.senderEmail)
    print("senderFax(발신자 팩스번호) : %s" % statement.senderFax + "\n")


    print("receiverCorpNum(수신자 사업자번호) : %s" % statement.receiverCorpNum)
    print("receiverTaxRegID(수신자 종사업장 식별번호) : %s" % statement.receiverTaxRegID)
    ...
    print("receiverEmail(수신자 메일주소) : %s" % statement.receiverEmail)
    ...
    for n in range(0, len(statement.detailList)):
        ...
        print("       itemName(품명) : %s " % statement.detailList[n].itemName)
